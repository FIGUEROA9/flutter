...
class CategoriaService {
  ...
  Future getCategoriaPorId(int id) async {
  ...
  Future crearCategoria(String nombre, String descripcion) async {
  ...
  Future actualizarCategoria(int id, String nombre, String descripcion) async {
    final headers = await _getHeaders();
